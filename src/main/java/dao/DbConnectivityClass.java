...
public class DbConnectivityClass {
    final static String DB_NAME="DerejDB";
        MyLogger lg= new MyLogger();
        final static String MYSQL_SERVER_URL = "jdbc:mysql://csc311sandoval27.mysql.database.azure.com/";
        final String DB_URL = MYSQL_SERVER_URL + DB_NAME;
        final static String USERNAME = "sandef3";// update this username
